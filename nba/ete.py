...
def map_marks(super_df, input_df):
    ...
    # Detect available Obtained Marks columns
    available_questions = []
    for i in range(1, 17):
    ...
    # Copy Obtained Marks to ete-q columns
    ...
    # Add missing ete-q columns if needed
    for i in range(1, 17):
        col = f'ete-q{i}'
...
if super_file and input_files:
    ...
    st.info("👆 Please upload a Super File and one or more Input Files.")
